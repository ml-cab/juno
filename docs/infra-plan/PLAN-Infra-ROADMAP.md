...
| 13   | `PLAN-Infra-Tier13.md` | Fused quant / FlashAttn (gated)         | P0 (13A ✓, 13B); P5 (FA) | 13A complete; **13B in progress** (flag `--mmq`, PTX Q4_K GEMV, Llama path); LoRA MMQ Phase 1 in progress ([`PLAN-Infra-LoRA-MMQ.md`](PLAN-Infra-LoRA-MMQ.md)) — **not** a new Infra tier |
...
| LoRA MMQ (13B adjacency) | [`PLAN-Infra-LoRA-MMQ.md`](PLAN-Infra-LoRA-MMQ.md)                                                                                                 | **Phase 1 in progress** (playback-only)                  | Fused Q4_K under `--lora-play`; train explicit no-op + warn; not an Infra tier |
