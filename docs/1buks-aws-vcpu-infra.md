...
The AWS Free Plan (introduced July 2025) explicitly restricts high-performance instances. High-spec instance types like `g4dn.xlarge` are not eligible for the free plan. 
...
One heads-up on budget: 2× g4dn.xlarge at $0.526/hr burns roughly **$1.05/hr**. Your $100 credit gives you ~95 hours of runtime, so consider using stop/start workflow to not wase it.
