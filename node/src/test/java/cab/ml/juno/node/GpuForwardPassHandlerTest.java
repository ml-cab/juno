...
class GpuForwardPassHandlerTest {
	...
	void distinct_request_ids_are_independent() {
		...
		ForwardResult r1 = h.forward(ForwardRequest.withTokens("req-A", new int[] { 1 }, 0), ctx);
		ForwardResult r2 = h.forward(ForwardRequest.withTokens("req-B", new int[] { 999 }, 0), ctx);
