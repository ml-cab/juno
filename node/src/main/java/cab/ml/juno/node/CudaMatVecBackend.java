 ...
 * mutable state.
 */
public final class CudaMatVecBackend implements MatVecBackend {

	@SuppressWarnings("unused")
	private static final Logger log = Logger.getLogger(CudaMatVecBackend.class.getName());
	 ...
	 */
	public CudaMatVecBackend(GpuContext ctx) {
		if (ctx == null)
